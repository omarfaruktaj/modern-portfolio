  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-400/10 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
        ...
        <div className="floating-element absolute top-20 left-20 w-4 h-4 bg-blue-500/20 rotate-45 animate-float"></div>
        <div className="absolute top-40 right-32 w-6 h-6 bg-purple-500/20 rounded-full animate-float animation-delay-1000"></div>
        <div className="absolute bottom-32 left-32 w-3 h-3 bg-indigo-500/20 rotate-45 animate-float animation-delay-2000"></div>
        <div className="absolute bottom-20 right-20 w-5 h-5 bg-pink-500/20 rounded-full animate-float animation-delay-3000"></div>
        <div className="absolute top-1/2 left-10 w-2 h-2 bg-cyan-500/30 rotate-45 animate-float animation-delay-1500"></div>
        <div className="absolute top-1/3 right-10 w-4 h-4 bg-emerald-500/20 rounded-full animate-float animation-delay-2500"></div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              <div className="mb-6">
                <p className="text-xl font-semibold text-blue-700 dark:text-blue-400 mb-4 animate-fade-in-up tracking-wide">
              ...
              >
                ...
                innovative design, and cutting-edge technologies. Let&apos;s
            ...
            {/* RIGHT */}
            <div
              className="text-center lg:text-right order-1 lg:order-2 opacity-0 translate-y-20"
              ref={imageRef}
            >
              <div className="relative inline-block">
                {/* Decorative Elements */}
                <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-500/10 rounded-full animate-pulse"></div>
                <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-purple-500/10 rounded-full animate-pulse animation-delay-1000"></div>

                {/* Main Image Container */}
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-300 animate-pulse"></div>
                ...
                {/* Floating Tech Icons */}
                <div className="absolute top-10 -left-6 bg-white dark:bg-gray-800 p-3 rounded-full shadow-lg animate-float">
                  <svg
                ...
                <div className="absolute bottom-10 -right-6 bg-white dark:bg-gray-800 p-3 rounded-full shadow-lg animate-float animation-delay-2000">
                  <svg
