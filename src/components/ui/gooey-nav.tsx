...
export const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  return (
    <>
      ...
      <div
        className="gooey-nav-container relative sm:hidden"
        ref={containerRef}
      >
        <div className="fixed bottom-0 left-0 right-0 z-50 w-full flex justify-center pb-4 sm:pb-6 md:static md:pb-0">
          <nav
          ...
          >
            <ul
              ref={navRef}
              className={cn(
                "flex gap-x-2 sm:gap-x-4 list-none p-0 px-2 sm:px-4 m-0 relative z-[3]"
              )}
              role="menubar"
